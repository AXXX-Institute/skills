...
[`skills/paper-to-poster/axxx/assets/`](../skills/paper-to-poster/axxx/assets/)
...
```bash
cd skills/paper-to-poster/axxx/assets
...
- Breaking change (renamed/removed file) → cut `assets-v2`, update
  `skills/paper-to-poster/axxx/config.json` (`assets_tag`) and the staged
